...
class SessionsController extends Controller
{
  ...
  public function index(){
    ...
    $equipo = Equipo::where('id_equipo', '=', $cliente->id_equipo)->get();

    $salida = shell_exec('./vivo.sh '.$this->getIdcliente().' '.$equipo->first()->noip);
  ...
  public function bloqueodesbloqueo($mac, $act, $descr, $orden, Request $request){
