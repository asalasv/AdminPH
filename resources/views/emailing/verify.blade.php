...
<div class="row">
	<div class="col-md-12">
		<div class="box">
			<div class="box-header with-border">
				<i class="fa fa-certificate"></i><h3 class="box-title">Activacion de Emailing</h3>
	...
	{!! Form::open(['route' => ['channge-email-verify'], 'method' =>'post', 'id' => 'form-change']) !!}
	{!!Form::close() !!}
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#cambiar').click(function(){
			...
			if (confirm('¿Está seguro que desea '+verbo+' la opcion de emailing para este cliente?')) {
				$.ajax({
						type: 'post',
						url: url,
						data: data,
